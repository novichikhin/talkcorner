...
from talkcorner.api.api_v1.endpoints import forum, subforum, healthcheck
...
def register_routers() -> APIRouter:
    ...
    router.include_router(subforum.router, prefix="/subforum", tags=["subforum"])

    router.include_router(
        healthcheck.router, prefix="/healthcheck", tags=["healthcheck"]
    )

    router.include_router(register_topic_routers(), prefix="/topic", tags=["topic"])
